    ...
    public class SplineInterpolator : MonoBehaviour
    {
        ...
        void Update()
        {
            ...
            if (mState != "Stopped")
            {
                ...
                // Smooth the param
                param = MathHelper.Ease(param, mNodes[mCurrentIdx].EaseIO.x, mNodes[mCurrentIdx].EaseIO.y);
        ...
        Quaternion GetSquad(int idxFirstPoint, float t)
        {
            ...
            Quaternion T1 = MathHelper.GetSquadIntermediate(Q0, Q1, Q2);
            Quaternion T2 = MathHelper.GetSquadIntermediate(Q1, Q2, Q3);

            return MathHelper.GetQuatSquad(t, Q1, Q2, T1, T2);
        }
        ...
        public Vector3 GetHermiteAtTime(float timeParam)
        {
            ...
            param = MathHelper.Ease(param, mNodes[idx].EaseIO.x, mNodes[idx].EaseIO.y);
